...
# APaulson,5.23.2020,Changed code to complete assignment 6
# APaulson,5.24.2020,Changed code in line 184 to change greeting
# ---------------------------------------------------------------------------- #
...
class IO:
    ...
    def input_task_to_remove():
        remove_task = input('Please enter the task you want removed: ')
        remove_task = remove_task.lower()
        return remove_task
